/*! graves-of-salad v0.0.1 - @quintenclause - 2016-10-21 */
...
"use strict";var x,y;return x=coord.column*this.tile_dimensions.x+this.tile_dimensions.x/2,y=coord.row*this.tile_dimensions.y+this.tile_dimensions.y/2,new Phaser.Point(x,y)};var bootState={create:function(){game.stage.backgroundColor=colors.normalBG,game.scale.scaleMode=Phaser.ScaleManager.RESIZE,game.stage.smoothed=!1,game.input.mouse.capture=!0,game.state.start("load")}},gameState={map:void 0,layer:void 0,cursors:void 0,player:void 0,enemies:void 0,pathfinding:void 0,emitter:void 0,create:function(){this.map=game.add.tilemap("map",16,16),this.map.addTilesetImage("tiles"),this.layer=this.map.createLayer(0),this.layer.resizeWorld(),this.map.setCollisionBetween(54,83);for(var walkableTiles=[],t=-1;t<54;t++)walkableTiles.push(t);var tile_dimensions=new Phaser.Point(this.map.tileWidth,this.map.tileHeight);this.pathfinding=this.game.plugins.add(Pathfinding,this.map.layers[0].data,walkableTiles,tile_dimensions),this.player=game.add.sprite(48,48,"player",1),this.player.animations.add("left",[8,9],10,!0),this.player.animations.add("right",[1,2],10,!0),this.player.animations.add("up",[11,12,13],10,!0),this.player.animations.add("down",[4,5,6],10,!0),game.physics.enable(this.player,Phaser.Physics.ARCADE),this.player.body.setSize(10,10,2,2),console.log(this.player.health),this.player.events.onKilled.add(this.playerKilled,this),game.camera.follow(this.player),this.cursors=game.input.keyboard.createCursorKeys(),this.emitter=game.add.emitter(this.player.position.x,this.player.position.y,200),this.emitter.makeParticles("redgibs",[0,1,2,3,4],200,!0,!0),this.emitter.minParticleSpeed.setTo(-200,-300),this.emitter.maxParticleSpeed.setTo(200,-400),this.emitter.gravity=150,this.emitter.bounce.setTo(.5,.5),this.emitter.angularDrag=30,this.enemies=[];var enemy=game.add.sprite(2e3,2e3,"enemy",1);enemy.animations.add("left",[8,9],10,!0),enemy.animations.add("right",[1,2],10,!0),enemy.animations.add("up",[11,12,13],10,!0),enemy.animations.add("down",[4,5,6],10,!0),game.physics.enable(enemy,Phaser.Physics.ARCADE),enemy.body.setSize(10,10,2,2),enemy.anchor.setTo(.5,.5),enemy.pathfinding={path:[],path_step:-1,searching:!1,walkspeed:gameData.settings.enemies.walkspeed,damage:gameData.settings.enemies.damage},this.enemies.push(enemy)},update:function(){game.physics.arcade.collide(this.emitter,this.layer),game.physics.arcade.collide(this.player,this.layer),this.player.body.velocity.set(0),this.cursors.left.isDown?(this.player.body.velocity.x=-100,this.player.play("left")):this.cursors.right.isDown?(this.player.body.velocity.x=100,this.player.play("right")):this.cursors.up.isDown?(this.player.body.velocity.y=-100,this.player.play("up")):this.cursors.down.isDown?(this.player.body.velocity.y=100,this.player.play("down")):this.player.animations.stop();for(var e=0;e<this.enemies.length;e++){var next_position,velocity,enemy=this.enemies[e];enemy.pathfinding.path.length<1&&game.physics.arcade.collide(enemy,this.layer,this.enemyMapCollide,null,this),enemy.body.velocity.set(0),enemy.pathfinding.path.length>0?(next_position=enemy.pathfinding.path[enemy.pathfinding.path_step],this.enemy_reached_target_position(enemy,next_position)?(enemy.position.x=next_position.x,enemy.position.y=next_position.y,enemy.pathfinding.path_step<enemy.pathfinding.path.length-1?enemy.pathfinding.path_step+=1:(enemy.pathfinding.path=[],enemy.pathfinding.path_step=-1,enemy.body.velocity.x=0,enemy.body.velocity.y=0)):(velocity=new Phaser.Point(next_position.x-enemy.position.x,next_position.y-enemy.position.y),velocity.normalize(),enemy.body.velocity.x=velocity.x*enemy.pathfinding.walkspeed,enemy.body.velocity.y=velocity.y*enemy.pathfinding.walkspeed),enemy.body.velocity.x<0?enemy.play("left"):enemy.body.velocity.x>0?enemy.play("right"):enemy.body.velocity.y<0?enemy.play("up"):enemy.body.velocity.y>0?enemy.play("down"):enemy.animations.stop()):Math.floor(enemy.body.x/8)>Math.floor(this.player.body.x/8)?(enemy.body.velocity.x=-enemy.pathfinding.walkspeed,enemy.play("left")):Math.floor(enemy.body.x/8)<Math.floor(this.player.body.x/8)?(enemy.body.velocity.x=enemy.pathfinding.walkspeed,enemy.play("right")):Math.floor(enemy.body.y/8)>Math.floor(this.player.body.y/8)?(enemy.body.velocity.y=-enemy.pathfinding.walkspeed,enemy.play("up")):Math.floor(enemy.body.y/8)<Math.floor(this.player.body.y/8)?(enemy.body.velocity.y=enemy.pathfinding.walkspeed,enemy.play("down")):enemy.animations.stop(),game.physics.arcade.collide(enemy,this.player,this.enemyPlayerCollide,null,this)}},enemy_reached_target_position:function(enemy,position){var distance;return distance=Phaser.Point.distance(enemy.position,position),distance<1},enemyMapCollide:function(enemy,map){if(!enemy.pathfinding.searching&&enemy.pathfinding.path.length<1){enemy.pathfinding.searching=!0;var callBackContext={move_through_path:function(path){null!==path?(enemy.pathfinding.path=path,enemy.pathfinding.path_step=0):enemy.pathfinding.path=[],enemy.pathfinding.searching=!1}};this.pathfinding.find_path(enemy.position,this.player.position,callBackContext.move_through_path,callBackContext)}},enemyPlayerCollide:function(enemy,player){player.health-=enemy.pathfinding.damage,console.log(player.health),player.health<0&&player.kill()},playerKilled:function(){this.emitter.x=this.player.x,this.emitter.y=this.player.y,this.emitter.start(!0,4e3,null,40),game.camera.shake(.05,500)},resize:function(){},shutdown:function(){this.map=void 0,this.layer=void 0,this.cursors=void 0,this.player=void 0,this.enemies=void 0,this.emitter=void 0}},loadState={nFontChecks:0,preload:function(){game.load.json("gameData","assets/data/game.json"),game.load.script("webfont","//ajax.googleapis.com/ajax/libs/webfont/1.4.7/webfont.js"),game.load.tilemap("map","assets/tilemaps/csv/graves.csv",null,Phaser.Tilemap.CSV),game.load.image("tiles","assets/tilemaps/tiles/tiles_16.png"),game.load.spritesheet("player","assets/sprites/eddy.png",16,16),game.load.spritesheet("redgibs","assets/sprites/redgibs.png",6,6),game.load.spritesheet("enemy","assets/sprites/salad.png",16,16)},create:function(){gameData=game.cache.getJSON("gameData"),this.checkFontLoaded()},checkFontLoaded:function(){loadState.nFontChecks++,fontName==googleFontName||loadState.nFontChecks>=6?game.state.start("splash"):setTimeout(loadState.checkFontLoaded,500)}},menuState={menuGroup:void 0,switched:!1,create:function(){this.menuGroup=game.add.group(),this.menuGroup.x=game.world.centerX,this.menuGroup.y=game.world.centerY;this.menuGroup.add(this.createText(0,-80,"Ready?\nHit spacebar"));this.spaceKey=game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR),game.input.keyboard.addKeyCapture([Phaser.Keyboard.SPACEBAR]),this.switched=!1},update:function(){this.spaceKey.downDuration(1e3)&&!this.switched&&(this.switched=!0,game.state.start("game"))},resize:function(){this.menuGroup.x=game.world.centerX,this.menuGroup.y=game.world.centerY},shutdown:function(){this.menuGroup=void 0},createText:function(x,y,text){var textSprite=game.add.text(x,y,text);return textSprite.anchor.setTo(.5),textSprite.font=fontName,textSprite.fontSize=32,textSprite.fill=colors.normalStroke,textSprite.align="center",textSprite}},splashState={text:void 0,create:function(){var text=splashState.text=game.add.text(game.world.centerX,game.world.centerY,"Once upon a night...");text.anchor.setTo(.5),text.font=fontName,text.fontSize=20,text.fill=colors.normalStroke,text.align="center",game.time.events.add(3*Phaser.Timer.SECOND,function(){game.state.start("menu")},this)},resize:function(){var text=splashState.text;text.x=game.world.centerX,text.y=game.world.centerY},shutdown:function(){splashState.text=void 0}},game,gameData,fontName="monospace",googleFontName="UnifrakturMaguntia",fx;window.PhaserGlobal={disableWebAudio:!0};var colors={normalBG:"#131822",normalStroke:"#31453e"},tints={normalBG:1251362,normalStroke:3228990};WebFontConfig={active:function(){fontName=googleFontName},google:{families:[googleFontName]}},window.onload=function(){game=new Phaser.Game("100%","100%",Phaser.CANVAS,""),game.state.add("boot",bootState),game.state.add("load",loadState),game.state.add("splash",splashState),game.state.add("menu",menuState),game.state.add("game",gameState),game.state.start("boot")};