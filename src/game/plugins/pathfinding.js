var Pathfinding = function (game, parent) {
    "use strict";
    Phaser.Plugin.call(this, game, parent);
    this.easy_star = new EasyStar.js();
};

Pathfinding.prototype = Object.create(Phaser.Plugin.prototype);
Pathfinding.prototype.constructor = Pathfinding;

Pathfinding.prototype.init = function (world_grid, acceptable_tiles, tile_dimensions) {
    "use strict";
...
Pathfinding.prototype.find_path = function (origin, target, callback, context) {
    "use strict";
...
Pathfinding.prototype.call_callback_function = function (callback, context, path) {
    "use strict";
    var path_positions;
    path_positions = [];
    if (path !== null) {
...
Pathfinding.prototype.get_point_from_coord = function (coord) {
    "use strict";
    var x, y;
